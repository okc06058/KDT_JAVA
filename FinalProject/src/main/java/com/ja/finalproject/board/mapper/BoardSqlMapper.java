...
public interface BoardSqlMapper {
	...
	// 좋아요
	public void insertLike(ArticleLikeDto articleLikeDto);
	public void deleteLike(ArticleLikeDto articleLikeDto);
	
	public int countLikeTotal(int article_id);
	public int countMyLike(ArticleLikeDto articleLikeDto);
