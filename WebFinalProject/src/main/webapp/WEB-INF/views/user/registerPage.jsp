				...
				<form action="./registerProcess" method="post">
					...
					<div class="row mt-3">
						<div class="col d-grid">
							...
							PW: <input name="password" type="password"><br> 닉네임:
							<input name="nickname" type="text"><br>
						</div>
					</div>
					<div class="row mt-3">
						<div class="col">
							성별: &nbsp&nbsp&nbsp<input name="gender" type="radio" value="M">&nbsp 남 &nbsp&nbsp&nbsp<input
								name="gender" type="radio" value="F">&nbsp 여 <br>
						</div>
						<div class="row mt-3">
							<div class="col d-grid">
