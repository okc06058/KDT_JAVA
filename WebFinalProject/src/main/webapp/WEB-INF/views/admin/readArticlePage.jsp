	...
	<div class="container">
		...
		<div class="row ">
			...
			<dlv class="col-5 mt-5">
			 	<div class = "row">
			 		<dlv class="col">
					 	<i class="bi bi-person ml-3 mb-3 "></i> <span class="fs-6">${qwer.adminDto.shopname }> </span><br>
						<span class="fs-4 p-3">${qwer.freeboardArticleDto.titlename }</span><br>
					</dlv>
			 	</div>
				<div class = "row">
					<div class="col-10">
						<span class="fs-3 fw-bolder ">${qwer.freeboardArticleDto.price } 원</span><br>
					</div>
					<dlv class="col">
					 	<i class="bi bi-heart ml-3 mb-3 "></i> &nbsp&nbsp&nbsp
						<i class="bi bi-share ml-3 mb-3 "></i><br>
					</dlv>
				</div>
				<div class = "row pt-3">
					<div class="col-8">
					...
					<dlv class="col">
					 	<span class="fs-6">&nbsp;&nbsp;남은수량 : ${qwer.freeboardArticleDto.total_count } 개</span> &nbsp
					</dlv>
				</div>
				<div class = "row pt-3">
					<div class="col-8">
				...
				<div class = "row pt-3">
					...
					<div class="col">	
						<span class="fs-6">토스페이&nbsp;&nbsp;&nbsp;</span><br>
						<span class="fs-6 text-secondary fst-italic"> 첫 결제시 0원 이상 2천원 캐시백</span><br>
		...
		<c:choose>
			<c:when test="${!empty sessionAdminInfo}">
				<form action="./writeCommentProcess" method="post">
					<input name="article_id" type="hidden"
						...
						name="user_id" type="hidden" value=${map.AdminDto.id }> <input
			...
			<c:otherwise>
				<input type="text" value="로그인해주세요"
					onclick="location.href =  '../admin/adminLoginPage';">
